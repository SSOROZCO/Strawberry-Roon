...
QFile qssFile(QString::fromUtf8(":/roon.qss"));
    if (qssFile.open(QFile::ReadOnly)) {
        qApp->setStyleSheet(QString::fromUtf8(qssFile.readAll()));
// INYECCIÓN TEMA DARK ROOM (ROON STYLE)
  QString darkRoomStyle = QString::fromUtf8(R"(
    ...
    /* Listas de reproducción, colecciones y tablas */
    QTreeView, QListView, QTableView, QHeaderView::section {
        background-color: #181818 !important;
        alternate-background-color: #1F1F1F !important;
    ...
    /* SOLUCIÓN: Botones de reproducción (Play, Pause, Stop, etc.) */
    ...
    /* Barras de desplazamiento (Scrollbars) estilo Roon minimalista */
  ...
  qApp->setStyleSheet(darkRoomStyle);
        qssFile.close();
    }
